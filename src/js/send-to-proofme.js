...
$( document ).ready( () =>  {
    ...
    function setDocumentHasProof(filesSummary, usersSummary, reviewsSummary, totalCount, unreadCount, proofUrl, itemCount){
        ...
        $('.buttonProofMe').html(`
            <img src='https://raw.githubusercontent.com/proofme/proofme-canva/master/src/images/icon-create-version%402x.png' alt="ProofMe" style="height: 20px; width: 20px; vertical-align: text-bottom;">
            Update Proof
        `)
                    ...
                    setTimeout( () => {
                        ...
                        if ($(".center").html() === "Your design is ready" && !popupClosed) {
                            ...
                            buttonsDom.append(`
                                ...
                                <img src='https://raw.githubusercontent.com/proofme/proofme-canva/master/src/images/icon-create-${proofExists?"version" : "proof"}%402x.png' alt="ProofMe" style="height: 20px; width: 20px; vertical-align: text-bottom;">
                                        ...
                                        <span class="closePopup">╳</span>
                                            ...
                                            <div class="centerPart">
                                                <div class="circleLogo">
                                                    <img src="https://raw.githubusercontent.com/proofme/proofme-canva/master/src/images/canva-sending-1%402x.png" alt="ProofMe" style="height:80px; width:80px;">
                                                </div>
...
const imageCollection = {
    approveThumbGreen: "https://raw.githubusercontent.com/proofme/proofme-canva/master/src/images/proof-update-dropdown-icons/approve-thumb-green%402x.png",
    approveThumbWhite: "https://raw.githubusercontent.com/proofme/proofme-canva/master/src/images/proof-update-dropdown-icons/approve-thumb-white%402x.png",
    rejectThumbRed: "https://raw.githubusercontent.com/proofme/proofme-canva/master/src/images/proof-update-dropdown-icons/reject-thumb-red%402x.png",
    rejectThumbWhite: "https://raw.githubusercontent.com/proofme/proofme-canva/master/src/images/proof-update-dropdown-icons/reject-thumb-white%402x.png",
    bubbleWithDot: "https://raw.githubusercontent.com/proofme/proofme-canva/master/src/images/proof-update-dropdown-icons/bubble-with-dot%402x.png",
    blueArrow: "https://raw.githubusercontent.com/proofme/proofme-canva/master/src/images/proof-update-dropdown-icons/Asset%205%402x.png",
    managerNote: "https://raw.githubusercontent.com/proofme/proofme-canva/master/src/images/owner-note.png"
}
